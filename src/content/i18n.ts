...
const ms = {
  ...
  qualityLabel: 'Kualiti grafik',
  qualityAuto: 'Auto',
  qualityLow: 'Rendah',
  qualityMid: 'Sederhana',
  qualityHigh: 'Tinggi',
  worksIn: 'Karya dalam',
...
const en: Dict = {
  ...
  freeWalkOn: 'Walk freely',
  freeWalkOff: 'Back to the line',
  freeWalkError: 'This window disallows pointer control — keep dragging to look around.',
  gyroLook: 'Look by tilting',
  gyroDenied: 'Tilt look was not allowed — keep dragging to look around.',
